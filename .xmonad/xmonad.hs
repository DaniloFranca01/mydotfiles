...
myFont :: String
myFont = "xft:Iosevka Term:regular:size=12:antialias=true:hinting=true"
...
myStartupHook = do  
  ...
  spawn ("sleep 2 && trayer --iconspacing 3 --edge top --align right --widthtype request --padding 3 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 " ++ colorTrayer ++ " --height 22")
  setWMName "LG3D"
...
myShowWNameTheme = def
    { swn_font              = "xft:Iosevka Term:regular:size=60"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#f8f8f2"
    , swn_color             = "#282a36"
    }
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        ...
        , ("S-<Print>", spawn "~/Scripts/screenshots.sh s")          -- selection screenshot
        , ("C-S-<Print>", spawn "~/Scripts/screenshots.sh i")        -- window screenshot

    -- KB_GROUP Useful programs to have a keybinding for launch
        , ("M-<Return>", spawn (myTerminal))
        , ("M-w", spawn (myBrowser))
        , ("M-b", spawn (myTerminal ++ " -e btop"))
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              -- XMOBAR SETTINGS
              { ppOutput = \x -> hPutStrLn xmproc1 x   -- xmobar on monitor 2
                -- Current workspace
